...
# RGB格式颜色转换为16进制颜色格式
def rgb_to_hex(rgb: Union[Tuple[int, int, int], Tuple[int, int, int, int]]):
    """
    说明:
        将rgb元组转换为16进制颜色
    参数:
